...
import { FileText, Download, Users, Zap, Shield, Globe } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Choose from beautifully designed, ATS-friendly resume templates"
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      description: "Join professionals who have successfully landed jobs with our builder"
    },
    {
      icon: Globe,
